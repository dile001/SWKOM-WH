...
public class ParcelApiController implements ParcelApi {
    ...
    public ResponseEntity<Void> reportParcelDelivery(
        ...
        try {
            ...
            notificationService.sendEmail("Parcel has been delivered!", "Parcel has been delivered!");
    ...
    public ResponseEntity<Void> reportParcelHop(
        ...
        try {
            ...
            notificationService.sendEmail("Parcel arrived at Hop!", "Parcel arrived at Hop!");
